                  ...
                  paginatedLancamentos.map(l => {
                    ...
                    return (
                      <tr key={l.id} className="border-b italic !h-auto hover:bg-muted/50 transition-colors">
                        ...
                        <td className={`text-right font-semibold w-[110px] whitespace-nowrap px-2 py-1 align-middle text-[12px] leading-tight ${l.sinal > 0 ? 'text-success' : l.sinal === 0 ? 'text-muted-foreground' : 'text-destructive'}`}>
                          {l.sinal === 0 ? formatMoeda(l.valor) : fmtValor(l.valor, l.sinal)}
                        </td>
