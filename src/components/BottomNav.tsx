...
export function BottomNav({ activeTab, onTabChange }: BottomNavProps) {
  ...
  const getActiveId = (tab: TabId): TabId => {
    ...
    const analiseTabs: TabId[] = ['visao_zoo_hub', 'zootecnico', 'zootecnico_hub', 'indicadores', 'visao_anual_zoo', 'analise', 'analise_entradas', 'analise_saidas', 'desfrute', 'evolucao', 'analise_operacional', 'pastos', 'lancar_fin_hub', 'visao_fin_hub', 'analise_economica', 'fechamento_executivo'];
