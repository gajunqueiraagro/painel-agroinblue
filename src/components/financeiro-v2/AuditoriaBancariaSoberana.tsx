...
/* O contexto que a Estação recebe ao resolver um extrato ou um lançamento sem vínculo.
   Ficou aqui quando a seção do espelho saiu (PR-ESPELHO-01): é da Estação, não dela. */
    ...
    <div className="space-y-1.5 p-2 overflow-auto h-full">
      ...
      {temExtrato && diag && (
        <>
          ...
          {/* PR-ESPELHO-01 — a seção mudou de casa. O espelho OFX × Sistema é ferramenta de
              trabalho, não leitura de fechamento, e passou a viver onde o operador concilia.
              Fica a linha, nunca uma cópia: duas telas com a mesma lista divergiriam no
