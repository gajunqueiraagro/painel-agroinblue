...
export function DashboardFinanceiro({
  ...
  return (
    <div className="w-full min-w-0 space-y-2">
      ...
      {/* ================================================================= */}
      <div className="grid gap-2 items-stretch mb-2 min-w-0 [&>*]:min-w-0" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))' }}>
        {/* Entradas */}
      ...
      {/* ================================================================= */}
      <div className="grid gap-2 items-stretch min-w-0 [&>*]:min-w-0" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))' }}>
      ...
      {/* ================================================================= */}
      <div className="grid gap-1.5 min-w-0 [&>*]:min-w-0" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))' }}>
