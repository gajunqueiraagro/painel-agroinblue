...
const ROWS: RowDef[] = [
  ...
  { label: 'Receitas Agrícolas', key: 'receitasAgri', indent: 2, tipo: 'entrada', amploOnly: true },
  ...
  { label: 'Financiamentos Pecuária', key: 'captacaoPec', indent: 2, tipo: 'entrada', amploOnly: true },
  { label: 'Financiamentos Agricultura', key: 'captacaoAgri', indent: 2, tipo: 'entrada', amploOnly: true },
  { label: 'Aportes ou Outros', key: 'aportes', indent: 2, tipo: 'entrada', amploOnly: true },
  ...
  { label: 'Custeio Pecuário', key: 'custeioPec', indent: 2, tipo: 'saida', amploOnly: true },
  { label: 'Investimentos Pecuária', key: 'investPec', indent: 2, tipo: 'saida', amploOnly: true },
  { label: 'Custeio Agrícola', key: 'custoioAgri', indent: 2, tipo: 'saida', amploOnly: true },
  { label: 'Investimentos Agricultura', key: 'investAgri', indent: 2, tipo: 'saida', amploOnly: true },
  { label: 'Reposição Bovinos', key: 'reposicao', indent: 1, tipo: 'saida' },
  { label: 'Despesas com Reposição', key: 'despesasReposicao', indent: 1, tipo: 'saida' },
  { label: 'Amortizações', key: 'amortizacoes', indent: 1, tipo: 'saida' },
  { label: 'Amortizações Pecuária', key: 'amortizacoesPec', indent: 2, tipo: 'saida', amploOnly: true },
  { label: 'Amortizações Agricultura', key: 'amortizacoesAgri', indent: 2, tipo: 'saida', amploOnly: true },
