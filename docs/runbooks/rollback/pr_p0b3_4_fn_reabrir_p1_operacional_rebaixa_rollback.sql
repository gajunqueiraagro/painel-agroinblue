-- ROLLBACK R4 (Migração 4 - fn_reabrir_p1_operacional rebaixa). Restaura o corpo
--   anterior (P0-A, SEM a chamada a fn_rebaixar_p1_oficial), capturado via
--   pg_get_functiondef. Nao reabre grants.
