...
-- 1. Update auto_create_transferencia_entrada to derive cenario from status_operacional
...
BEGIN
  ...
  -- Derive cenario from status_operacional
  v_cenario := CASE WHEN NEW.status_operacional = 'previsto' THEN 'meta' ELSE 'realizado' END;
  ...
  INSERT INTO public.lancamentos (
    ...
    NEW.preco_medio_cabeca, NEW.observacao, NEW.id, NEW.status_operacional, v_cenario
  )
...
-- 2. Update sync_transferencia_update to derive cenario from status_operacional
