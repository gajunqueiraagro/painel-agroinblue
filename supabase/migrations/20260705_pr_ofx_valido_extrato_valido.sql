-- ============================================================================
-- PR-OFX-VALIDO-1 — Fechamento segue OFX VÁLIDO; bruto vira diagnóstico rotulado.
-- Delta ADITIVO sobre fn_conciliacao_soberana (corpo VIGENTE do pg_proc, versao
-- soberana-01.10-grupos-conciliados). ÚNICA mudança:
--   1) resumo.extrato_cru += 'ignorados_valor' (Σ signed de desc_ofx);
--   2) resumo += bloco 'extrato_valido' (a partir do CTE 'ofx', que já exclui
--      status='ignorado').
-- Nenhuma outra parte muda: CTEs, vínculos, buckets e grupos intactos.
-- ============================================================================
