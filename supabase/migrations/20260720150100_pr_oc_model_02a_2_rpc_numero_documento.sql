-- PR-OC-MODEL-02A parte 2 — wiring do numero_documento no contrato soberano.
--   CÓPIA VERBATIM do oc_salvar_rascunho vigente (PR-OC-MODEL-01 M4), acrescentando
--   SOMENTE numero_documento em 3 pontos: coluna do INSERT (create), valor do INSERT e
--   SET do UPDATE. Nenhuma outra linha muda. Toda escrita OC segue exclusiva por RPC.
...
BEGIN
  ...
  IF p_operacao_id IS NULL THEN
    INSERT INTO public.zoo_operacoes_comerciais (
      ...
      valor_estimado, valor_acordado, numero_documento, observacoes, status_comercial, rascunho, status_financeiro, versao, created_by, updated_by)
    VALUES (
      ...
      p_payload->>'numero_documento', p_payload->>'observacoes', 'programada', true, 'nao_aplicavel', 1, v_actor, v_actor)
