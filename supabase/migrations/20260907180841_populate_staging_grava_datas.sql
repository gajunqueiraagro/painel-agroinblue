-- 20260907180841 populate_staging_grava_datas (aplicada no proto via Management API em 07/09/2026)
...
BEGIN
  ...
  LOOP
    ...
    INSERT INTO financeiro_classificacao_staging (sessao_id, cliente_id, excel_linha_origem, excel_subcentro, excel_fornecedor, excel_produto,
      ...
      excel_fazenda_codigo, excel_observacao, excel_documento, match_lancamento_id, match_status, update_proposto, alias_id_usado, excel_data_pagamento, excel_data_vencimento
      ...
      NULLIF(v_row->>'data_pagamento','')::date, NULLIF(v_row->>'data_vencimento','')::date
