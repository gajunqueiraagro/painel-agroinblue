-- 20260908114919 vw_staging_preview_conta_filtro_entradas (aplicada no proto via Management API em 08/09/2026)
CREATE OR REPLACE VIEW public.vw_classificacao_staging_preview WITH (security_invoker = on) AS
 SELECT s.staging_id,
    s.sessao_id,
    s.cliente_id,
    s.match_status,
