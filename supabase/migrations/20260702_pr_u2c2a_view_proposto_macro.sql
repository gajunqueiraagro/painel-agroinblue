-- ============================================================================
-- PR-U2c-2A — View expõe proposto_macro (para o FazendaSelect na Mesa forçar
-- "Administrativo" quando macro='Dividendos', igual ao lançamento oficial).
-- +1 coluna ao final (CREATE OR REPLACE). Aditiva/retrocompat: linha sem macro
-- proposto → NULL. Nenhuma lógica operacional depende disso.
-- ============================================================================
