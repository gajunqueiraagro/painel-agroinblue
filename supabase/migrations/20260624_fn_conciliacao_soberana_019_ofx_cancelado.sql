-- ============================================================================
-- SOBERANA-01.9  |  fn_conciliacao_soberana(p_cliente, p_conta, p_mes)
-- DELTA 01.9 (cirurgico, sobre 01.8): ofx_base passa a filtrar e.cancelado_em
--   IS NULL — OFX com soft delete (cancelado_em) saem do diagnostico. Resto
--   identico a 01.8 (vinculos ativos no links_raw preservados).
-- ----------------------------------------------------------------------------
...
SELECT jsonb_build_object(
  'gerado_em', now(),
  'versao', 'soberana-01.9-ofx-cancelado',
