-- 20260629_fn_ws_conciliacao_guard_cbi_ativo.sql
-- Versiona o corpo VIVO de fn_ws_conciliacao (gerado por pg_get_functiondef),
-- que adiciona ao cálculo de v_vincular um guard: só habilita vincular quando o
-- extrato do candidato único NÃO possui vínculo ativo em conciliacao_bancaria_itens.
-- Conteúdo = corpo vivo verbatim (não reconstruído). Já aplicado no proto.
